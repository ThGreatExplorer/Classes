...
\begin{corollary}{\textbf{Law of Large Numbers}\\
  ...
  .\] 
  Then, $E_n \to E[X_1]$ in probability as $n \to \infy$. 
  The time average (average of experiment throughout time) = space average (space of possiblities, multiverse perspective)
  \begin{proof}
    \begin{align*}
